...
public class Visualizer extends JFrame implements ActionListener {
	...
	public Visualizer() throws InterruptedException {
		...
		name = new JLabel("Developed by: Paras | Ojas | Manas");
		...
		// Drop-down menu
		algorithms = new JComboBox<String>(new String[]{"Select Algorithm", "Bubble Sort", "Heap Sort", "Insertion Sort", "Merge Sort", "Selection Sort", "Quick Sort"});
